...
final class GuardrailsService: GuardrailsServiceProtocol {
    ...
    func listKeyAssignments(
        ...
        try await httpClient.execute(
            .listGuardrailKeyAssignments(guardrailId: guardrailId, offset: offset, limit: limit),
            expectedStatusCode: 200
        )
    }
    ...
    func listMemberAssignments(
        ...
        try await httpClient.execute(
            .listGuardrailMemberAssignments(guardrailId: guardrailId, offset: offset, limit: limit),
            expectedStatusCode: 200
        )
    }
